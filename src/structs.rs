...
pub struct Block {
    ...
    pub published: bool,
    pub created_date: Option<CapiDateTime>,
    pub first_published_date: Option<CapiDateTime>,
    pub published_date: Option<CapiDateTime>,
    pub last_modified_date: Option<CapiDateTime>,
...
pub struct WitnessElementFields {
    ...
    pub photographer: Option<String>,
    pub date_created: Option<CapiDateTime>,
...
pub struct AssetFields {
    ...
    pub identifier: Option<String>,
    pub price: Option<String>,
    pub start: Option<CapiDateTime>,
    pub end: Option<CapiDateTime>,
    pub safe_embed_code: Option<bool>,
}
